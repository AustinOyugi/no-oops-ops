...
The project currently supports a local Docker Swarm and a plain-HTTP internal registry. Router/TLS support and registry garbage collection policy are not implemented. See [Current limitations](docs/limitations.md).
